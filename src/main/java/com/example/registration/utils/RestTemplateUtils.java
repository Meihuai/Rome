...
public class RestTemplateUtils {
    ...
    public static <T> ResponseEntity<T> post(String url, Map<String, String> headers, Object requestBody, Class<T> responseType, Object... uriVariables) {
        ...
        return post(url, headers, requestBody, responseType, uriVariables);
    }
    ...
    public static void main(String[] args) {
        ...
        NodeReqeust reqeust=new NodeReqeust();
        reqeust.setAppId("user");
        reqeust.setIp("127.0.0.1");
        reqeust.setPort(80);
        ResponseEntity<Result> post = RestTemplateUtils.post("http://127.0.0.1:8848/api/addServer", headers, reqeust, Result.class);
